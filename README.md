# Hailuo 2.3 API (hailuo-2.3 / hailuo2.3) — api guide with published pricing

> **default $0.0248; 1080P $0.0424** — flat per-unit billing through the OpenAI-compatible APIMart gateway, $1 minimum top-up.

**[Live pricing](https://go.apimart.ai/k-e4a94c)** · **[Get an API key](https://go.apimart.ai/k-cd5660)**
